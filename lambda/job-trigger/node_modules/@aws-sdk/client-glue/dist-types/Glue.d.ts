...
export interface Glue {
    ...
    createCatalog(args: CreateCatalogCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateCatalogCommandOutput) => void): void;
    /**
     ...
     */
    createGlueIdentityCenterConfiguration(args: CreateGlueIdentityCenterConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<CreateGlueIdentityCenterConfigurationCommandOutput>;
    createGlueIdentityCenterConfiguration(args: CreateGlueIdentityCenterConfigurationCommandInput, cb: (err: any, data?: CreateGlueIdentityCenterConfigurationCommandOutput) => void): void;
    createGlueIdentityCenterConfiguration(args: CreateGlueIdentityCenterConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateGlueIdentityCenterConfigurationCommandOutput) => void): void;
    /**
     ...
     */
    createIntegrationResourceProperty(args: CreateIntegrationResourcePropertyCommandInput, options?: __HttpHandlerOptions): Promise<CreateIntegrationResourcePropertyCommandOutput>;
    createIntegrationResourceProperty(args: CreateIntegrationResourcePropertyCommandInput, cb: (err: any, data?: CreateIntegrationResourcePropertyCommandOutput) => void): void;
    createIntegrationResourceProperty(args: CreateIntegrationResourcePropertyCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateIntegrationResourcePropertyCommandOutput) => void): void;
    /**
     * @see {@link CreateIntegrationTablePropertiesCommand}
     */
    createIntegrationTableProperties(args: CreateIntegrationTablePropertiesCommandInput, options?: __HttpHandlerOptions): Promise<CreateIntegrationTablePropertiesCommandOutput>;
    createIntegrationTableProperties(args: CreateIntegrationTablePropertiesCommandInput, cb: (err: any, data?: CreateIntegrationTablePropertiesCommandOutput) => void): void;
    createIntegrationTableProperties(args: CreateIntegrationTablePropertiesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateIntegrationTablePropertiesCommandOutput) => void): void;
    /**
    ...
    deleteCatalog(args: DeleteCatalogCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteCatalogCommandOutput) => void): void;
    /**
    ...
    deleteGlueIdentityCenterConfiguration(args: DeleteGlueIdentityCenterConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<DeleteGlueIdentityCenterConfigurationCommandOutput>;
    deleteGlueIdentityCenterConfiguration(args: DeleteGlueIdentityCenterConfigurationCommandInput, cb: (err: any, data?: DeleteGlueIdentityCenterConfigurationCommandOutput) => void): void;
    deleteGlueIdentityCenterConfiguration(args: DeleteGlueIdentityCenterConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteGlueIdentityCenterConfigurationCommandOutput) => void): void;
    /**
     ...
     */
    deleteIntegrationTableProperties(args: DeleteIntegrationTablePropertiesCommandInput, options?: __HttpHandlerOptions): Promise<DeleteIntegrationTablePropertiesCommandOutput>;
    deleteIntegrationTableProperties(args: DeleteIntegrationTablePropertiesCommandInput, cb: (err: any, data?: DeleteIntegrationTablePropertiesCommandOutput) => void): void;
    deleteIntegrationTableProperties(args: DeleteIntegrationTablePropertiesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteIntegrationTablePropertiesCommandOutput) => void): void;
    /**
     ...
     */
    describeConnectionType(args: DescribeConnectionTypeCommandInput, options?: __HttpHandlerOptions): Promise<DescribeConnectionTypeCommandOutput>;
    describeConnectionType(args: DescribeConnectionTypeCommandInput, cb: (err: any, data?: DescribeConnectionTypeCommandOutput) => void): void;
    describeConnectionType(args: DescribeConnectionTypeCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeConnectionTypeCommandOutput) => void): void;
    /**
    ...
    getCatalog(args: GetCatalogCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetCatalogCommandOutput) => void): void;
    /**
    ...
    getCatalogs(args: GetCatalogsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetCatalogsCommandOutput) => void): void;
    /**
    ...
    getGlueIdentityCenterConfiguration(args: GetGlueIdentityCenterConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<GetGlueIdentityCenterConfigurationCommandOutput>;
    getGlueIdentityCenterConfiguration(args: GetGlueIdentityCenterConfigurationCommandInput, cb: (err: any, data?: GetGlueIdentityCenterConfigurationCommandOutput) => void): void;
    getGlueIdentityCenterConfiguration(args: GetGlueIdentityCenterConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetGlueIdentityCenterConfigurationCommandOutput) => void): void;
    /**
     * @see {@link GetIntegrationResourcePropertyCommand}
     */
    getIntegrationResourceProperty(args: GetIntegrationResourcePropertyCommandInput, options?: __HttpHandlerOptions): Promise<GetIntegrationResourcePropertyCommandOutput>;
    getIntegrationResourceProperty(args: GetIntegrationResourcePropertyCommandInput, cb: (err: any, data?: GetIntegrationResourcePropertyCommandOutput) => void): void;
    getIntegrationResourceProperty(args: GetIntegrationResourcePropertyCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetIntegrationResourcePropertyCommandOutput) => void): void;
    /**
     * @see {@link GetIntegrationTablePropertiesCommand}
     */
    getIntegrationTableProperties(args: GetIntegrationTablePropertiesCommandInput, options?: __HttpHandlerOptions): Promise<GetIntegrationTablePropertiesCommandOutput>;
    getIntegrationTableProperties(args: GetIntegrationTablePropertiesCommandInput, cb: (err: any, data?: GetIntegrationTablePropertiesCommandOutput) => void): void;
    getIntegrationTableProperties(args: GetIntegrationTablePropertiesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetIntegrationTablePropertiesCommandOutput) => void): void;
    /**
    ...
    listConnectionTypes(args: ListConnectionTypesCommandInput, options?: __HttpHandlerOptions): Promise<ListConnectionTypesCommandOutput>;
    listConnectionTypes(args: ListConnectionTypesCommandInput, cb: (err: any, data?: ListConnectionTypesCommandOutput) => void): void;
    listConnectionTypes(args: ListConnectionTypesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListConnectionTypesCommandOutput) => void): void;
    /**
    ...
    updateCatalog(args: UpdateCatalogCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateCatalogCommandOutput) => void): void;
    /**
    ...
    updateGlueIdentityCenterConfiguration(args: UpdateGlueIdentityCenterConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<UpdateGlueIdentityCenterConfigurationCommandOutput>;
    updateGlueIdentityCenterConfiguration(args: UpdateGlueIdentityCenterConfigurationCommandInput, cb: (err: any, data?: UpdateGlueIdentityCenterConfigurationCommandOutput) => void): void;
    updateGlueIdentityCenterConfiguration(args: UpdateGlueIdentityCenterConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateGlueIdentityCenterConfigurationCommandOutput) => void): void;
    /**
     * @see {@link UpdateIntegrationResourcePropertyCommand}
     */
    updateIntegrationResourceProperty(args: UpdateIntegrationResourcePropertyCommandInput, options?: __HttpHandlerOptions): Promise<UpdateIntegrationResourcePropertyCommandOutput>;
    updateIntegrationResourceProperty(args: UpdateIntegrationResourcePropertyCommandInput, cb: (err: any, data?: UpdateIntegrationResourcePropertyCommandOutput) => void): void;
    updateIntegrationResourceProperty(args: UpdateIntegrationResourcePropertyCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateIntegrationResourcePropertyCommandOutput) => void): void;
    /**
     * @see {@link UpdateIntegrationTablePropertiesCommand}
     */
    updateIntegrationTableProperties(args: UpdateIntegrationTablePropertiesCommandInput, options?: __HttpHandlerOptions): Promise<UpdateIntegrationTablePropertiesCommandOutput>;
    updateIntegrationTableProperties(args: UpdateIntegrationTablePropertiesCommandInput, cb: (err: any, data?: UpdateIntegrationTablePropertiesCommandOutput) => void): void;
    updateIntegrationTableProperties(args: UpdateIntegrationTablePropertiesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateIntegrationTablePropertiesCommandOutput) => void): void;
    /**
