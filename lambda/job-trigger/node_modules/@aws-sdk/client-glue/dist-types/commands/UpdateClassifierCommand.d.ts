...
declare const UpdateClassifierCommand_base: {
    new (input: UpdateClassifierCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateClassifierCommandInput, UpdateClassifierCommandOutput, GlueClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [UpdateClassifierCommandInput]): import("@smithy/smithy-client").CommandImpl<UpdateClassifierCommandInput, UpdateClassifierCommandOutput, GlueClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateClassifierCommand extends UpdateClassifierCommand_base {
