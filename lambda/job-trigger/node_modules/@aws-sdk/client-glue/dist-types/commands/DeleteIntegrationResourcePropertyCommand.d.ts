...
import { DeleteIntegrationResourcePropertyRequest, DeleteIntegrationResourcePropertyResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DeleteIntegrationResourcePropertyCommand_base: {
    new (input: DeleteIntegrationResourcePropertyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIntegrationResourcePropertyCommandInput, DeleteIntegrationResourcePropertyCommandOutput, GlueClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteIntegrationResourcePropertyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIntegrationResourcePropertyCommandInput, DeleteIntegrationResourcePropertyCommandOutput, GlueClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
