...
import { CreateIntegrationResourcePropertyRequest, CreateIntegrationResourcePropertyResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateIntegrationResourcePropertyCommand_base: {
    new (input: CreateIntegrationResourcePropertyCommandInput): import("@smithy/smithy-client").CommandImpl<CreateIntegrationResourcePropertyCommandInput, CreateIntegrationResourcePropertyCommandOutput, GlueClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateIntegrationResourcePropertyCommandInput): import("@smithy/smithy-client").CommandImpl<CreateIntegrationResourcePropertyCommandInput, CreateIntegrationResourcePropertyCommandOutput, GlueClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
