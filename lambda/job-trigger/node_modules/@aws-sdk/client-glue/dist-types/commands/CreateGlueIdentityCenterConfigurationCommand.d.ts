...
import { CreateGlueIdentityCenterConfigurationRequest, CreateGlueIdentityCenterConfigurationResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateGlueIdentityCenterConfigurationCommand_base: {
    new (input: CreateGlueIdentityCenterConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateGlueIdentityCenterConfigurationCommandInput, CreateGlueIdentityCenterConfigurationCommandOutput, GlueClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateGlueIdentityCenterConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateGlueIdentityCenterConfigurationCommandInput, CreateGlueIdentityCenterConfigurationCommandOutput, GlueClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
